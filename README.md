...
- 실습  
  ...
  > _W03-2. 정적페이지 수집: 실시간검색어, 영화댓글 수집_  
  > _APPENDIX 02. Assignment: 영화댓글 수집기_  
  
#### WEEK 04. 웹크롤링 실전 활용 & 텍스트 데이터 전처리 이해하기
- 웹크롤링 실전활용법 및 적용사례 소개
- 실습  
  > _W04-1. 동적페이지 수집: 카페 게시글 수집_  
  > _W04-2. 동적페이지 수집: 해시태그 수집_  
  
#### WEEK 05. 텍스트 데이터 전처리 실전 적용하기
- 형태소분석과 개체명인식
- 실습  
  > _W05-1. 한국어 텍스트 데이터 전처리: KoNLPy_  
  > _W05-2. 영어 텍스트 데이터 전처리: NLTK_
...
- 단어와 문서를 벡터로 표현하는 방법: Word2Vec, Doc2Vec  
  > _W10-1. 뉴스기사 텍스트 데이터 임베딩_  
  > _W10-2. 위키피디아 텍스트 데이터 임베딩_
